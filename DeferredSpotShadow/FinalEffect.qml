    ...
    techniques : [
        ...
        Technique {
            ...
            renderPasses : RenderPass {
                ...
                shaderProgram : ShaderProgram {
                    id : finalShaderGL3
                    vertexShaderCode: loadSource(Qt.resolvedUrl("./shaders/deferred.vert"))
                    fragmentShaderCode: loadSource(Qt.resolvedUrl("./shaders/deferred.frag"))
        ...
        Technique {
            ...
            renderPasses : RenderPass {
                ...
                shaderProgram : ShaderProgram {
                    id : finalShaderGL2
                    vertexShaderCode: loadSource(Qt.resolvedUrl("./shaders/deferred_gl2.vert"))
                    fragmentShaderCode: loadSource(Qt.resolvedUrl("./shaders/deferred_gl2.frag"))
                }
            }
        }]
}
